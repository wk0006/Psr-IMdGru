...
def mdgru(X_train,X_test,y_train,y_test,NHIDDEN1,NHIDDEN2,NHIDDEN3,EP):
...
def mdlstm(X_train,X_test,y_train,y_test,NHIDDEN1,NHIDDEN2,NHIDDEN3,EP):
    from sklearn.preprocessing import StandardScaler
    x_scaler = StandardScaler()
    y_scaler = StandardScaler()
